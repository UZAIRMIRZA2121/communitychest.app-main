...
(function ($) {
    ...
    function updateThemeSetting(id) {
        if ($("#light-mode-switch").prop("checked") == true && id === "light-mode-switch") {
            ...
            $("#dark-mode-switch").prop("checked", false);
            $("#dark-rtl-mode-switch").prop("checked", false);
            $("#bootstrap-style").attr('href', 'public/assets/css/bootstrap.rtl.css');
            $("#app-style").attr('href', 'public/assets/css/app.rtl.css');
            $("html").attr("dir", 'rtl');
            ...
            $("#rtl-mode-switch").prop("checked", false);
            $("#dark-mode-switch").prop("checked", false);
            $("#bootstrap-style").attr('href', 'public/assets/css/bootstrap-dark.rtl.css');
            $("#app-style").attr('href', 'public/assets/css/app-dark.rtl.css');
            $("html").attr("dir", 'rtl');
